       ...
       <div class="btn-group float-sm-right">
		...
		<div class="row" >
			...
			<?php
				...
				$query = mysql_query("select * from canceled_appointments, user, staff where canceled_appointments.user_id=user.user_id && canceled_appointments.staff_id=staff.staff_id && canceled_appointments.staff_id = '$id'");
