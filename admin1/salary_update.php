<?php
	...
	else
	{
		...
		if(isset($_GET['editid']))
		{
			...
			$query=mysql_query("select * from salary where salary_id='$id'");
	   ...
	   <div class="card-body">
			...
			<div class="form-group">
					<label for="input-6">Staff ID</label>
						<input type="text" class="form-control form-control-rounded" id="input-6" name = "s_id" value="<?php echo $result['staff_id']; ?>" disabled>
			</div>
