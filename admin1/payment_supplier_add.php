...
<script>
	...
	$("document").ready(function(){
		...
		$("#add").click(function(){
			...
			qua = test_num("#qua","#msgqua");

			if(name == true && amt == true && details == true && type == true && pay == true && qua == true)
			{
       ...
       <div class="col-lg-12">
	     <div class="col-lg-6">
		  ...
		  <form action = "payment_supplier_process.php" method = "post" >
			...
			<div class="form-group">
				<label for="input-5">Product Details</label>
				  <input type="text" class="form-control form-control-rounded" id="details" placeholder="Enter Product Details" name = "pay_details" required/>
			...
			<div class="form-group">
				<label for="input-5">Product Quantity</label>
				  <input type="text" class="form-control form-control-rounded" id="qua" name = "pay_qua" placeholder="Enter Product Quantity" required/>
				  <span id = "msgqua"></span>
			</div>
