			...
			if($_FILES['file1']['name'])
			{
				...
				if($arrFileName[1] == 'csv')
				{
					...
					while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) 
					{
						...
						$import = "insert into appointment(appointment_id, user_id, appointment_details, appointment_date, appointment_time, payment_type, staff_id) values('$item1','$item2', '$item3' , '$item4' , '$item5', '$item6', '$item7', '$item8')";
