<?php 
	...
	else
	{
		...
		if(isset($_SESSION['add_payment_user']) && $_SESSION['add_payment_user']!="")
		{
			echo $_SESSION['add_payment_user'];
			
			unset($_SESSION['add_payment_user']);
		}
       ...
       <div class="btn-group float-sm-right">
		...
		<div class="row" >
			...
			<?php
				...
				$query = mysql_query("select * from sale,user,product, payment_user where sale.user_id=user.user_id && sale.product_id=product.product_id && payment_user.payment_user_id = sale.payment_id");
			...
			<tr>
				...
				<td colspan="2"> <center> <a href = "sale_update.php?editid=<?php echo $result['sale_id']; ?>">
