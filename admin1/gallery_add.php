...
<script>
	...
	$("document").ready(function(){
		...
		$("#add").click(function(){
			...
			var iname,vname,pic,video;

			iname = test_name("#iname","#msginame");
			
			vname = test_name("#vname","#msgvWname");

			pic = test_file("#pic","#msgpic");

			video = test_file("#video","#msgvideo");
			
			if(iname == true && vname == true && pic == true && video == true)
			{
				return true;
	     ...
	     <div class="col-lg-6">
		  ...
		  <form action = "gallery_process.php" method = "post" enctype = "multipart/form-data" >
            ...
            <label for="input-1">Video</label>
			 <div class="input-group mb-3">
                  <div class="custom-file">
                    <input type="file" class=" form-control custom-file-input" id="video" name="video">
                    <label class="custom-file-label" for="inputGroupFile02">Choose file</label>
                  </div>
                  <div class="input-group-append">
                    <span class="input-group-text">Upload</span>
				  ...
				  <!--<input type="file" class="form-control" id="exampleInputName1" name = "video" required/>-->
                  <span id="msgvideo"></span>
			</div>

			<div class="form-group">
            <label for="input-2">Video Name</label>
				  <input type="text" class="form-control form-control-rounded" id="vname" id="input-1" placeholder="Enter Video Name" name = "v_name" required/>
