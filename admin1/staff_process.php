<?php
	...
	{	
		...
		if(isset($_POST['add_staff']))
		{
			...
			$s_dob = $_POST['year']."-".$_POST['month']."-".$_POST['date'];
			...
			{						
				$add = mysql_query("insert into staff(staff_id, staff_name, staff_password, staff_gender, staff_address, staff_contact, staff_dob, staff_email, staff_salary, staff_specialization, staff_commission, staff_cus_handled) values ('$s_id','$s_name','$s_pass','$s_gender','$s_add','$s_contact','$s_dob','$s_email','$u_salary','$s_specialization','$s_commission','$s_customer')");	
