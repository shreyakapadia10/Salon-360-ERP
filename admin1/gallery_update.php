	   ...
	   <div class="card-body">
			...
			<div class="form-group">
					<label for="input-6">Image ID</label>
						<input type="text" class="form-control form-control-rounded" id="input-6" name = "i_id" value="<?php echo $result['image_id']; ?>" disabled>
			</div>
			...
			<br><video src = "gallery/<?php echo $result['video']; ?>" height = "100" width = "100"> </video> 
			 <div class="input-group mb-3">
                  <div class="custom-file">
                   <br> <input type="file" class=" form-control custom-file-input" id="inputGroupFile02" name="video">
                    <label class="custom-file-label" for="inputGroupFile02">Choose file</label>
                  </div>
				  <div class="input-group-append">
						<button class="btn btn-white" type="button">Button</button>
			...
			<div class="form-group">
					<label for="input-6">Video Name</label>
						<input type="text" class="form-control form-control-rounded" id="input-6" name = "v_name" value="<?php echo $result['video_name']; ?>">
			</div>
