<?php 
	...
	if(isset($_POST['upload']))
		...
		if(isset($_POST['update']))
		{
			...
			{
				$_SESSION['update_treatment']="<script>alert('Treatment Details Can't Be Updated');</script>";
		...
		if(isset($_GET['del']))
		{
			...
			if(mysql_query("delete from treatment_details where treatment_id='$id'"))
			{
				$_SESSION['delete_treatment']="<script>alert('Treatment Details Deleted Successfully');</script>";
			...
			{
				$_SESSION['delete_treatment']="<script>alert('Treatment Details Can't Be Deleted');</script>";
