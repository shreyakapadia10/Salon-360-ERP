<?php
	...
	else
	{
		...
		if(isset($_GET['editid']))
		{
			...
			$query=mysql_query("select * from payment_user p,user u where payment_user_id='$id' && p.user_id=u.user_id");
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Update User Payment</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="home.php">Salon 360 ERP</a></li>
            <li class="breadcrumb-item"><a href="payment_user.php">User Payment</a></li>
            <li class="breadcrumb-item active" aria-current="page">Update User Payment</li>
         </ol>
	   </div>
   </div>
...
<div class="col-lg-6">
	<div class="card">
	   <div class="card-body">
			<div class="card-title">Update User Payment</div> <hr>

			<form class="forms-sample" action = "payment_user_process.php" method = "post" >

			<div class="form-group">
					<label for="input-6">Payment ID</label>
						<input type="text" class="form-control form-control-rounded" id="input-6" name = "pay_id" value="<?php echo $result['payment_user_id']; ?>" disabled>
			</div>
			
			<div class="form-group">
					<label for="input-6">User Name</label>
						<input type="text" class="form-control form-control-rounded" id="input-6" name = "user_id" value="<?php echo $result['user_name']; ?>" disabled>
			</div>
			...
			<div class="form-group">
					<label for="input-6">Quantity</label>
						<input type="text" class="form-control form-control-rounded" id="input-6" name = "quantity" value="<?php echo $result['product_quantity']; ?>">
			</div>
		<input type="hidden" name="editid" value="<?php echo $result['payment_user_id']; ?>">
		<button type="submit" class="btn btn-success btn-round waves-effect waves-light m-1" name = "update"> <i class="zmdi zmdi-edit"></i> Update User Payment</button>
