       ...
       <div class="btn-group float-sm-right">
		...
		<div class="row" >
			...
			<?php
				...
				$query = mysql_query("select * from appointment, user, staff, treatment_details where appointment.user_id=user.user_id && appointment.staff_id=staff.staff_id && appointment.appointment_details=treatment_details.treatment_name");
