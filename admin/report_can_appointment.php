    ...
    <!-- Breadcrumb-->
     <div class="row pt-2 pb-2">
        <div class="col-sm-9" >
            ...
            <li class="breadcrumb-item"><a href="canceled_appointment_list.php">Canceled Appointment</a></li>
            <li class="breadcrumb-item"><a href="">Cancel Appointment Report</a></li>
         </ol>
	   </div>
		  ...
		  <?php if(isset($_POST['submit']) && isset($_POST['submit'])!="")
				{
					...
					$end=strtotime($_POST['end']);
					 $end1 = date('y-m-d',$end);
					$query=mysql_query("select * from canceled_appointments, user, staff where appointment_date between '$start1' and '$end1' && canceled_appointments.user_id=user.user_id && canceled_appointments.staff_id=staff.staff_id");
			?>
