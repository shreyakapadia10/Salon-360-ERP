       ...
       <div class="btn-group float-sm-right">
		...
		<div class="row" >
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header" style="font-size:20px"><i class="fa fa-table fa-lg"></i> Sale Detail</div>
						<div class="card-body">
								&nbsp;&nbsp;<a href="report_sale_detail.php"><Button type="submit" name="report" class="btn btn-primary waves-effect waves-light m-1">Get Report</button></a><br>
			...
			<?php
				...
				$query = mysql_query("select * from sale_detail s, sale where s.sale_id=sale.sale_id");
