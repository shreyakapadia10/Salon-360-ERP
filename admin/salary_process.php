<?php
	...
	{	
		if(isset($_POST['add_salary']))
		{
			...
			$add = mysql_query("insert into salary (staff_id, salary, commission, total_salary, salary_date) values ('$s_id','$sal','$com','$t_sal',CURDATE())");
			
			mysql_query("insert into notification_staff(staff_id, notification_title, notification, notification_date, notification_time) values ('$s_id','Salary Added', '$t_sal added into your account', CURDATE(), CURTIME())");
		...
		if(isset($_GET['del']) && $_GET['del']!="")
		{
			...
			$_SESSION['delete_salary']="<script>alert('Salary Deleted Successfully');</script>";
