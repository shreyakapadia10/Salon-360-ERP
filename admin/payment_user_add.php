...
<script>
	...
	$("document").ready(function(){
		...
		$("#add").click(function(){
			...
			var name,amt,details,type,pay, qua;
		  ...
		  <form action = "payment_user_process.php" method = "post" >
			...
			<div class="form-group">
				<label for="input-5">Product Quantity</label>
				  <input type="text" class="form-control form-control-rounded" id="qua" name = "quantity" placeholder="Enter Payment Amount" required/>
				  <span id="msgqua"></span>
			</div>
