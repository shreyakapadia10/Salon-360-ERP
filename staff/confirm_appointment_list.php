       ...
       <div class="btn-group float-sm-right">
		...
		<div class="row" >
			...
			<?php
				...
				$query = mysql_query("select * from confirm_appointment, user, staff where confirm_appointment.user_id=user.user_id && confirm_appointment.staff_id=staff.staff_id &&  confirm_appointment.staff_id = '$id'");
			...
			<tr>
				...
				<td colspan="2"> <center> <a href = "status_update.php?editid=<?php echo $result['confirm_appointment_id']; ?>"> 
