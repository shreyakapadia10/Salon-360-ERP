;(function ($) {
    ...
    $(window).on('load', function () {
        ...
        beautyzone_col_offset();
        beautyzone_header_sticky();
        beautyzone_scroll_to_top();
        beautyzone_quantity_icon();
    });
    ...
    /* =================
     Column Absolute
     =================== */
    function beautyzone_col_offset() {
    ...
    function beautyzone_header_sticky() {
    ...
    /* ====================
     Scroll To Top
     ====================== */
    function beautyzone_scroll_to_top() {
    ...
    function beautyzone_quantity_icon() {
