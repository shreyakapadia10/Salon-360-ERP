...
<div id="pagetitle" class="page-title bg-overlay"> <div class="container"> <div class="page-title-inner"> <h1 class="page-title"><?php echo $result['user_name']; ?>'s Profile</h1> <ul class="ct-breadcrumb"><li><a class="breadcrumb-entry" href="../index.html">Home</a></li><li><span class="breadcrumb-entry"><?php echo $result['user_name']; ?>'s Profile</span></li></ul> </div> </div></div> 


<div id="content" class="site-content"> <div class="content-inner"> <div class="container content-container"> <div class="row content-row"> <div id="primary" class="content-area content-full-width col-12"> <main id="main" class="site-main"> <article id="post-16" class="post-16 page type-page status-publish hentry"> <div class="entry-content clearfix"> <div class="vc_row-full-width vc_clearfix"></div>


<div class="vc_row-full-width vc_clearfix"></div><div class="vc_row wpb_row vc_row-fluid bg-image-ps-inherit"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner vc_custom_1538834974217"><div class="wpb_wrapper"><div class="vc_row wpb_row vc_inner vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-2"><div class="vc_column-inner"><div class="wpb_wrapper"></div></div></div><div class="wpb_column vc_column_container vc_col-sm-8 rm-padding-md"><div class="vc_column-inner vc_custom_1538063128965"><div class="wpb_wrapper"><div id="ct-heading-2" class="ct-heading align-center align-center-md align-center-sm align-center-xs "> <h3 class="ct-heading-tag "style = "margin-top:25px;" > My Profile </h3> <div class="ct-heading-separator"><i class="flaticon-spa"></i></div> </div></div></div></div><div class="wpb_column vc_column_container vc_col-sm-2"><div class="vc_column-inner"><div class="wpb_wrapper"></div></div></div></div>

<div class="vc_empty_space" style="height: 10px" ><span class="vc_empty_space_inner"></span></div>

<!-- user details -->

<div class="vc_row wpb_row vc_inner vc_row-fluid"><div class="vc_column-inner vc_custom_1538844072775"><div class="wpb_wrapper"><div class="ct-team-member-default "> <div class="ct-team-member-inner clearfix"> 

<!-- user pic -->
<form action = "user_update.php" method = "post" enctype = "multipart/form-data" class = "vc_col-sm-5" style = "margin-left:30%;">

<div class="ct-team-member-image"> 

<img class="" src="gallery/<?php echo $result['user_pic']; ?>" width="500" height="500" alt="<?php echo $result['user_name']; ?>" title="<?php echo $result['user_name']; ?>" /> 
...
<input type = "text"  name = "uname" value = "<?php echo $result['user_name']; ?> " >
...
<select name = "gender">
	...
	<option 
		...
		<?php if($result['user_gender']=="Female")
		{	
			echo "selected"; 
		}
	...
	<option 
		...
		<?php if($result['user_gender']=="Male")
		{	
			echo "selected"; 
		}
...
<input type = "text" name = "add" value = "<?php echo $result['user_address']; ?>" minlength = "25"> 

<br><br>

<input type = "tel" name = "contact" value = "<?php echo $result['user_contact']; ?>" minlength = "10" maxlength = "10">

<br><br>

<input id="datepicker" type = "date" name = "dob" value = "<?php echo $result['user_dob']; ?>" >

<br><br>

<input type = "email" name = "email" value = "<?php echo $result['user_email']; ?>" >

<br><br>

<input type = "text" name = "city" value = "<?php echo $result['user_city']; ?>" >

<br><br>

<input type = "text" name = "greetings" value = "<?php echo $result['user_greetings']; echo " Greetings"; ?>" disabled>

<br><br>

<input type = "text" name = "points" value = "<?php echo $result['user_points']; echo " Points"; ?>" disabled>

<br><br>

<input type = "text" name = "purchase_items" value = "<?php echo $result['user_purchase_items']; echo " Purchased Items"; ?>" disabled>

<br><br>

<input type = "submit" name = "submit" value = "Update Profile"> </button>
...
</div></div></div></div> </div> </article> </main> </div> </div> </div></div></div>
